...
from evaluation import i2t, t2i, AverageMeter, LogCollector, encode_data, compute_sims
...
def main():
    ...
    parser.add_argument('--val_step', default=2000000, type=int,
...
def validate(opt, val_loader, model):
    ...
    img_embs, cap_embs, cap_lens, image_entity_idxs, caps_entity_idxs = encode_data(
